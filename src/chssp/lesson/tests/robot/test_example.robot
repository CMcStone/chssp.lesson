...
#
#  $ bin/test -s chssp.lesson -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src chssp.lesson.testing.CHSSP_LESSON_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/chssp/lesson/tests/robot/test_example.robot
#
